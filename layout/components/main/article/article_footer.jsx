    ...
    if (license?.length > 0) {
      return (
        <section id='license'>
          ...
          <div
            className='body'
            dangerouslySetInnerHTML={{ __html: markdown(license) }}
          />
        </section>
      )
    } else {
        ...
        <div className='body'>
          ...
          <div className='social-wrap dis-select'>
            {theme.article.share.map((item) => {
              if (
                ['wechat', 'weibo', 'telegram', 'email', 'link'].includes(item)
              ) {
                const shareTitle =
                  page.seo_title || page.title + ' - ' + config.title
                ...
                switch (item) {
                  case 'weibo':
                    ...
                    return (
                      <a
                        className='social share-item weibo'
                        target='_blank'
                  ...
                  case 'wechat':
                    return (
                      <a
                        className='social share-item wechat on-click-event'
                  ...
                  case 'telegram':
                    return (
                      ...
                      >
                        <img
                          src={url_for('/images/telegram.svg')}
                          alt='telegram'
                        />
                      </a>
                    )
                  ...
                  case 'link':
                    return (
                      <a
                        className='social share-item link on-click-event'
                        data-on-click={`util.copy('copy-link', "${__('message.copied')}")`}
                        key={item}
                      >
                        <img
                          src={url_for('/images/link_icon.svg')}
                          alt='link'
                        />
                      </a>
                    )
