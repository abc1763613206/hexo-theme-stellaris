...
const GitHubUser = (props) => {
  ...
  return (
    <widget className='widget-wrapper ghuser'>
      <div
        className='widget-body ds-ghinfo'
      ...
      >
        ...
        <p className='bio' type='text' id='bio'>
          &nbsp;
        </p>
          ...
          {buttons.map((btn, i) => {
            return (
              <a
                className='button'
                key={i}
                href={`https://github.com/${props.username}${btn.href}`}
              >
                <span className='title' type='text' id={btn.key}>
                  0
                </span>
        ...
        {props.menu && <SidebarMenu where='sidebar' {...props} />}
      </div>
    </widget>
  )
}
